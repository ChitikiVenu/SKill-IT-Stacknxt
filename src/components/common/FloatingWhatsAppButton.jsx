...
export default function FloatingWhatsAppButton() {
    ...
    return (
        <a
            ...
            className={`fixed bottom-5 left-5 z-40 grid h-12 w-12 place-items-center rounded-full bg-[#25D366] text-white shadow-xl shadow-emerald-900/20 transition-all duration-300 hover:scale-105 sm:bottom-7 sm:left-7 sm:h-14 sm:w-14 ${visible ? 'translate-y-0 opacity-100' : 'pointer-events-none translate-y-4 opacity-0'}`}
        >
            <svg
                viewBox='0 0 32 32'
